...
export default Medicamentos = ({ navigation, route }) => {
    ...
    useEffect(() => {
        fetch(global.UBYMED_WS_BASE + 'api/usuario', {
            ...
            body: JSON.stringify({
                action: "getMedicamentosCategorias",
            })
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <Text style={styles.modalText}>Lo sentimos. En este momento no hay medicamentos disponibles</Text>
            <TouchableOpacity
                style={[styles.button, styles.buttonClose]}
                onPress={() => {
            ...
            <View style={styles.containerServicios}>
                ...
                <View style={styles.espaceadorServicioHeader}></View>
...

                {
                    dataMostrar.map((item) => {
                        return (
                            <React.Fragment key={item["medicamentos_categoria"]}>
                                <View style={styles.servicioMainContainer} >
                                    <TouchableOpacity onPress={() => navigation.navigate('MedicamentosDetalle', { idDetalle: item["medicamentos_categoria"] })}>
